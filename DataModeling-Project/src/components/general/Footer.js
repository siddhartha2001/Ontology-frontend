  ...
  return (
    <div className='footer'>
        <div className="footer-container">
            ...
            <div className='right'>
                <h4><FaMailBulk size={20} style={{color:'#fff',marginRight:'2rem'}}/>Job Portal Site</h4>
                    <p>
                        Job Portal site powered by Semantic technology.
                        <br /><br /><br />
                        We have 4 logins.<br/>
                        ...
                        <br /><br /><br />
                        The Admin adds companies to the database.
